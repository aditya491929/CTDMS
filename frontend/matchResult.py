...
class MatchResult:
    ...
    def giveResult(self):
        ...
        loser1 = self.loser
        print(loser1)
        result = addMatchResult(self.matchDetails[0], tossWon, over1, run1, wicket1,
                                extra1, over2, run2, wicket2, extra2, manOfMatch, winner, loser1)
        if result:
    ...
    def __init__(self, master, details):
        ...
        self.matchNoEntry = Message(self.master, font=(
            'Yu Gothic', 20), text=self.matchDetails[0], background='#d9d9d9', relief='flat')
        ...
        self.tossSelect = ttk.Combobox(self.master, width=20, font=(
            'Yu Gothic', 20), background="#d9d9d9")
        self.tossSelect['values'] = (
            self.matchDetails[1], self.matchDetails[2])
        self.tossSelect.place(x=1106, y=207, width=200)
        self.tossSelect.current()

        self.runs1Entry = Entry(self.master, font=(
            'Yu Gothic', 20), textvariable=self.runs1, background='#d9d9d9', relief='flat')
        self.runs1Entry.place(x=100, y=388, width=200)

        self.overs1Entry = Entry(self.master, font=(
            'Yu Gothic', 20), textvariable=self.overs1, background='#d9d9d9', relief='flat')
        self.overs1Entry.place(x=447, y=388, width=200)

        self.wickets1Entry = Entry(self.master, font=(
            'Yu Gothic', 20), textvariable=self.wickets1, background='#d9d9d9', relief='flat')
        self.wickets1Entry.place(x=100, y=513, width=200)

        self.extras1Entry = Entry(self.master, font=(
            'Yu Gothic', 20), textvariable=self.extras1, background='#d9d9d9', relief='flat')
        self.extras1Entry.place(x=447, y=513, width=200)

        self.runs2Entry = Entry(self.master, font=(
            'Yu Gothic', 20), textvariable=self.runs2, background='#d9d9d9', relief='flat')
        self.runs2Entry.place(x=875, y=388, width=200)

        self.overs2Entry = Entry(self.master, font=(
            'Yu Gothic', 20), textvariable=self.overs2, background='#d9d9d9', relief='flat')
        self.overs2Entry.place(x=1225, y=388, width=200)

        self.wickets2Entry = Entry(self.master, font=(
            'Yu Gothic', 20), textvariable=self.wickets2, background='#d9d9d9', relief='flat')
        self.wickets2Entry.place(x=875, y=513, width=200)

        self.extras2Entry = Entry(self.master, font=(
            'Yu Gothic', 20), textvariable=self.extras2, background='#d9d9d9', relief='flat')
        self.extras2Entry.place(x=1225, y=513, width=200)

        self.momSelect = ttk.Combobox(self.master, width=20, font=(
            'Yu Gothic', 20), background="#d9d9d9")
        ...
        self.winSelect = ttk.Combobox(self.master, width=20, font=(
            'Yu Gothic', 20), background="#d9d9d9")
        ...
        self.loseSelect = Message(self.master, width=70, font=(
            'Yu Gothic', 16), text="", background="#d9d9d9")
        ...
        self.saveBtn = Button(self.master, width=10, background='#7ed957', relief='flat', text='Save', font=(
            'Yu Gothic', 18, 'bold'), command=self.giveResult)
