...
class AdminWindow:
    ...
    def __init__(self,master,adminId):
        ...
        self.scrlbar = ttk.Scrollbar(self.tournaments,orient="vertical", command=self.tournaments.yview)
        ...
        self.idEntry = Entry(self.label1, font=('Yu Gothic', 14, 'bold'),textvariable=self.tourId)
